...
type UploaderConfig struct {
	...
	AllowedFileTypes       types.StringArray `gorm:"column:allowed_file_types;type:text[]" json:"allowedFileTypes"`
	AllowedSources         types.StringArray `gorm:"not null;type:text[];column:allowed_sources" json:"allowedSources"`
	RequiredMetadataFields types.StringArray `gorm:"not null;column:required_metadata_fields;type:text[]" json:"requiredMetadataFields"`
