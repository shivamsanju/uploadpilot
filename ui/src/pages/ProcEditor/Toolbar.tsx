...
export const Toolbar = () => {
    const { nodes, setNodes, edges, setEdges, isUpdating, isPending, handleSave, getLayoutedElements } = useCanvas();
    ...
    return (
        <Group justify="center" >
            <Button variant="default" c="dimmed" onClick={() => onFormat()}>Format</Button>
