...
const statusConfig: Record<string, { color: string; icon: React.ReactNode }> = {
  ...
  Uploaded: { color: 'green', icon: <IconCircleCheck size={18} /> },
  Failed: { color: 'red', icon: <IconAlertHexagon size={18} /> },
  Cancelled: { color: 'gray', icon: <IconCancel size={18} /> },
  Processing: { color: 'teal', icon: <Loader size={18} /> },
  'Processing Failed': { color: 'red', icon: <IconAlertHexagon size={18} /> },
  'Processing Complete': {
    color: 'green',
    icon: <IconRosetteDiscountCheckFilled size={18} />,
  },
  'Processing Cancelled': { color: 'gray', icon: <IconCancel size={18} /> },
