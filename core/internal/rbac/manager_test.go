...
func setupManager(t *testing.T) *AccessManager {
	...
	manager, err := NewAccessManager("policy.csv")
	if err != nil {
		...
		testCases := []struct {
		...
		}{
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user1", "tenant1", "workspace1", "admin")
				},
				userID:       "user1",
				tenantID:     "tenant1",
			...
			},
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user2", "tenant1", "workspace1", "reader")
				},
				userID:       "user2",
				tenantID:     "tenant1",
				workspaceID:  "workspace1",
			...
			},
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user3", "tenant1", "workspace1", "end-user")
				},
				userID:       "user3",
				tenantID:     "tenant1",
				workspaceID:  "workspace1",
	...
	t.Run("Tenant-Level (All Workspaces) Access", func(t *testing.T) {
		testCases := []struct {
		...
		}{
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user1", "tenant1", "*", "admin")
				},
				userID:       "user1",
				tenantID:     "tenant1",
				workspaceID:  "workspace1",
	...
	t.Run("Cross-Tenant Access Control", func(t *testing.T) {
		testCases := []struct {
			...
			},
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user2", "tenant1", "*", "admin")
					_ = am.AddAccess("user2", "tenant2", "*", "reader")
				},
				userID:       "user2",
				tenantID:     "tenant2",
				workspaceID:  "workspace1",
			...
			},
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user3", "tenant1", "*", "admin")
					_ = am.AddAccess("user3", "tenant2", "*", "reader")
				},
				userID:       "user3",
				tenantID:     "tenant2",
				workspaceID:  "workspace1",
			...
			},
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user4", "tenant1", "*", "admin")
					_ = am.AddAccess("user4", "tenant2", "*", "end-user")
				},
				userID:       "user4",
				tenantID:     "tenant2",
				workspaceID:  "workspace1",
	...
	t.Run("Complex Access Patterns", func(t *testing.T) {
		testCases := []struct {
		...
		}{
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user1", "tenant1", "workspace1", "admin")
					_ = am.AddAccess("user1", "tenant1", "workspace2", "reader")
				},
			...
			},
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user1", "tenant1", "workspace1", "admin")
					_ = am.AddAccess("user1", "tenant1", "workspace2", "reader")
					_ = am.AddAccess("user1", "tenant2", "workspace1", "end-user")
...
func TestOtherThings(t *testing.T) {
		...
		testCases := []struct {
		...
		}{
			{
				...
				setupFunc: func(am *AccessManager) {
					...
					_ = am.AddAccess("user1", "tenant1", "workspace1", "manager")
				},
				userID:       "user1",
				tenantID:     "tenant1",
				workspaceID:  "workspace1",
			...
			},
			{
				...
				setupFunc: func(am *AccessManager) {
					...
					_ = am.AddAccess("user1", "tenant1", "workspace1", "super-reader")
				},
				userID:       "user1",
				tenantID:     "tenant1",
				workspaceID:  "workspace1",
	...
	// Test GetSubjectRoles and GetUserTenantAccess
	t.Run("Query Functions", func(t *testing.T) {
		t.Run("GetUserRoles", func(t *testing.T) {
			...
			_ = am.AddAccess("user1", "tenant1", "workspace1", "admin")
			_ = am.AddAccess("user1", "tenant1", "workspace2", "reader")
			_ = am.AddAccess("user1", "tenant2", "workspace3", "end-user")

			roles, err := am.GetSubjectRoles("user1")
			assert.NoError(t, err, "GetSubjectRoles should not return error")
		...
		t.Run("GetUserTenantAccess", func(t *testing.T) {
			...
			access, err := am.GetSubjectTenantAccess("user1", "tenant1")
	...
	t.Run("Multiple Role Scenarios", func(t *testing.T) {
		testCases := []struct {
		...
		}{
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user1", "tenant1", "workspace1", "admin")
					_ = am.AddAccess("user1", "tenant1", "workspace1", "reader")
				},
				checkFunc: func(am *AccessManager) bool {
			...
			},
			{
				...
				setupFunc: func(am *AccessManager) {
					_ = am.AddAccess("user1", "tenant1", "*", "reader")
					_ = am.AddAccess("user1", "tenant1", "workspace1", "admin")
				},
				checkFunc: func(am *AccessManager) bool {
	...
	t.Run("Comprehensive Access Control Test", func(t *testing.T) {
		...
		_ = am.AddAccess("user1", "tenant1", "*", "admin")           // All workspaces admin in tenant1
		_ = am.AddAccess("user1", "tenant2", "workspace1", "reader") // Specific workspace in tenant2

		_ = am.AddAccess("user2", "tenant1", "workspace1", "reader")   // Specific workspace in tenant1
		_ = am.AddAccess("user2", "tenant1", "workspace2", "end-user") // Another workspace in tenant1

		_ = am.AddNewRole("admin", "super-admin")                         // New role inheriting from admin
		_ = am.AddAccess("user3", "tenant1", "workspace1", "super-admin") // User with new role
