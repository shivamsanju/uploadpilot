...
const options = {
  ...
  s3: {
    ...
    useAccelerateEndpoint:
      config.optional.integrations.s3.useAccelerateEndpoint || false,
  ...
  sendSelfEndpoint: config.optional.selfEndpoint || "localhost:8082",
  ...
  periodicPingStaticPayload: JSON.parse(
    config.optional.periodicPingStaticPayload || '{"static": "payload"}'
  ),
